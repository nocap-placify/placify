        ...
        <div className="relative min-h-screen overflow-hidden bg-black">
            ...
            <div className={`absolute inset-0 ${isInputActive ? 'backdrop-blur-lg' : ''}`}>
                ...
                <div className={`relative z-10 flex min-h-screen flex-col items-center justify-center px-4 transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                    <h1 className="typewriter font-bold text-white" style={{ fontSize: '3.5rem', transform: 'translateY(-60px)' }}>
                        Student Login
                    </h1>
                    ...
                    <div className="mt-4 relative w-80">
                        <input
                            ...
                            style={{ border: '1px solid rgba(255, 255, 255, 0.5)', transition: 'border-color 0.3s ease' }}
                        />
                        <button
                ...
                <style jsx>{`
                    ...
                    .animate-pulse { animation: pulse 5s infinite ease-in-out; }
                `}</style>
